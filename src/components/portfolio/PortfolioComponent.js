...
import OldPhotos5 from '../../img/img_portfolio/Old_photos/old_photos5.jpg';
import OldPhotos6 from '../../img/img_portfolio/Old_photos/old_photos6.jpg';
...
const PortfolioComponent = () => {
  ...
  const showPhotoshop = () => {
    ...
    setText(
      <>
        <div className="portfolio__1  swing-in-top-fwd" id="a">
        ...
        <div className="portfolio__5  swing-in-top-fwd">
          <div className="skill2">
        ...
        <div className="portfolio__9  swing-in-top-fwd">
          <div className="skill2">
            ...
            <div id="carouselExampleIndicators9" className="carousel slide">
              <div className="carousel-indicators">
                ...
                <button type="button" data-bs-target="#carouselExampleIndicators9" data-bs-slide-to="3"
                  aria-label="Slide 4"></button>
                <button type="button" data-bs-target="#carouselExampleIndicators9" data-bs-slide-to="4"
                  aria-label="Slide 5"></button>
                <button type="button" data-bs-target="#carouselExampleIndicators9" data-bs-slide-to="5"
                  aria-label="Slide 6"></button>
              ...
              <div className="carousel-inner">
                ...
                <div className="carousel-item">
                  <img src={OldPhotos5} className="d-block w-100" alt="Old_photos" />
                </div>
                <div className="carousel-item">
                  <img src={OldPhotos6} className="d-block w-100" alt="Old_photos" />
                </div>
        ...
        <div className="portfolio__6 swing-in-top-fwd">
          <div className="skill2">
        ...
        <div className="portfolio__8  swing-in-top-fwd">
          <div className="skill2">
        ...
        <div className="portfolio__7  swing-in-top-fwd">
          <div className="skill2">
            Метрики
          </div>
          <div className="portfolio__img">
  ...
  const showFigma = () => {
    setText(
      <>
   <div className="portfolio__4  swing-in-top-fwd">
          <div className="skill2">
          ...
          <button className="portfolio__figma"><a className="portfolio__figma__text"
        ...
        <div className="portfolio__3  swing-in-top-fwd">
          <div className="skill2">
            Макет, сделанный с помощью Figma
          </div>
          <div className="portfolio__img">
  ...
  const showIllustrator = () => {
    setText(
      <>
        <div className="portfolio__10  swing-in-top-fwd">
          <div className="skill2">
  ...
  const showTilda = () => {
    setText(
      <>
      <div className="portfolio__11  swing-in-top-fwd">
          <div className="skill2">
          ...
          <button className="portfolio__figma"><a className="portfolio__figma__text" href="https://medkids74.tilda.ws"
              target="_blank" rel="noopener noreferrer">Перейти на сайт</a></button>
        </div>

        <div className="portfolio__12  swing-in-top-fwd">
          <div className="skill2">
            Сайт портфолио
          </div>
          <div className="portfolio__img">
          ...
          <button className="portfolio__figma"><a className="portfolio__figma__text" href="https://elenanovikovawork.tilda.ws/"
              target="_blank" rel="noopener noreferrer">Перейти на сайт</a></button>
        </div>
 </>
    );
  ...
  const showNetworks = () => {
    setText(
      <>
        <div className="portfolio__2  swing-in-top-fwd">
          <div className="skill2 ">
  ...
  return (
    <div className='portfolio'>
      ...
      <div className='work'>
        ...
        <button className="work__btn btn1" onClick={showPhotoshop} style={{ backgroundColor: text ? 'green' : 'gray'}} >Работы, созданные в Photoshop</button>
        <button className="work__btn btn2" onClick={showFigma} style={{ backgroundColor: text ? 'green' : 'gray'}}>Работы, созданные в Figma</button>
        <button className="work__btn btn3" onClick={showIllustrator} style={{ backgroundColor: text ? 'green' : 'gray'}}>Работы, созданные в illustrator</button>
        <button className="work__btn btn4" onClick={showTilda} style={{ backgroundColor: text ? 'green' : 'gray'}} >Работы, созданные в Tilda</button>
        <button className="work__btn btn5" onClick={showNetworks} style={{ backgroundColor: text ? 'green' : 'gray'}}>Работы для социальных сетей</button>
